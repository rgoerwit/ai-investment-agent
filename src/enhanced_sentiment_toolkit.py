...
COMPANY_NAME_TRANSLATIONS = {
    ...
    "BBRI.JK": {
        "native": "Bank Rakyat Indonesia",
        "romanized": "Bank Rakyat Indonesia",
    },
...
"""
    ...
    try:
        ...
        bullish_count = (
            tv_text.count("bullish")
            + tv_text.count("positive")
            + tv_text.count("upside")
        )
        bearish_count = (
            tv_text.count("bearish")
            + tv_text.count("negative")
            + tv_text.count("downside")
        )
    ...
    try:
        ...
        bullish_count = (
            inv_text.count("buy")
            + inv_text.count("bullish")
            + inv_text.count("strong buy")
        )
        bearish_count = (
            inv_text.count("sell")
            + inv_text.count("bearish")
            + inv_text.count("strong sell")
        )
...
"""
    ...
    logger.info(
        "multilingual_sentiment_search_completed",
        ticker=ticker,
