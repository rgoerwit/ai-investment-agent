...
- **Evidence-bound analysis publishing** — Registered tool payloads enter through a typed, fail-closed contract before LLM rendering; material claims retain source and period provenance; positive score credits require transitive fact lineage; corrected facts and scores project from one canonical snapshot; BUY recommendations must cite eligible supporting facts rather than scores alone; and invalid analyses or unapproved articles are retained as diagnostic/draft artifacts.
