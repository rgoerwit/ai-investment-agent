# Description: Development environment root configuration.
# This file defines the Terraform backend and calls the main infrastructure
# module with variables specific to the 'dev' environment.
#
...
# Call the root module with dev-specific variables
